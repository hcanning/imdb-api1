    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 403) {
          throw new Error(
            `API Access Error (403): ${
              errorData.message || 'You are not subscribed to this API'
            }`
          );
      ...
      setError(
        err instanceof Error ? err.message : 'Failed to load movies from API'
      );
      setMovies([]);
    } finally {
      setLoading(false);
        ...
        <div className='container text-center'>
          <div className='alert alert-danger'>
            ...
            <p className='mb-3'>
              ...
              <br />
              1. Check that your RapidAPI key is subscribed to the "IMDB Top 100
              Movies" API
              <br />
          ...
          <div className='row align-items-center'>
            <div className='col'>
              ...
              <p className='mb-0 opacity-75'>
                Discover the greatest films of all time
              </p>
            </div>
